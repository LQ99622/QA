...
model_name_or_path = "./test_model/t5-small"
...
def get_data_for_fine_tuning(path, n_epochs, learning_rate,
    ...
    """
    train_filenaeme = path.split(".")[0] + "_train_split.csv"
    val_filenaeme = path.split(".")[0] + "_val_split.csv"
    dataset_name = path.split("-")[-1].split(".csv")[0]
    # print(11111111111, train_filenaeme)
    # print(22222222222, val_filenaeme)
    # print(33333333333, dataset_name)
    ...
    # print(44444444444, checkpoint_filename)
...
if __name__ == '__main__':
    ...
    # print(11111111111, train_df)
    # print(22222222222, val_df)
    # print(33333333333, checkpoint_filename)
